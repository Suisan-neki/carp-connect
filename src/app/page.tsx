    ...
    <Layout>
      ...
      <section className="bg-red-600 text-white py-20">
        <div className="container mx-auto px-4 text-center">
          ...
          <div className="flex flex-col md:flex-row justify-center gap-4">
            <Link href="/stadium-map" className="bg-white text-red-600 font-bold py-3 px-6 rounded-lg hover:bg-gray-100 transition">
              スタジアムマップを見る
            </Link>
            <Link href="/tourism" className="bg-transparent border-2 border-white text-white font-bold py-3 px-6 rounded-lg hover:bg-white hover:text-red-600 transition">
              カープツーリズムを探る
            </Link>
          </div>
        </div>
      ...
      <section className="py-16">
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {/* 既存の機能カード（スタジアムマップ、球場ルール、カープツーリズム）はそのまま */}
            <Link href="/stadium-map" className="block">
            ...
            <Link href="/tourism" className="block">
              <div className="bg-white rounded-lg shadow-lg p-6 hover:shadow-xl transition cursor-pointer">
                <div className="text-red-600 text-4xl mb-4">
                  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" className="w-12 h-12">
      ...
      <section className="bg-gray-100 py-16">
        <div className="container mx-auto px-4 text-center">
          ...
          <Link href="/about" className="bg-red-600 text-white font-bold py-3 px-8 rounded-lg hover:bg-red-700 transition">
            もっと詳しく
          </Link>
        </div>
      </section>
